...
def main():
    ...
    if inputBegin == "ready":
        ...
        while True:
            ...
            numberGuessed = possibilities[middle]

            guessingResult = input("My guess is %s. If right, write 'right', if too low, write 'low', if too high, write 'high':" % str(numberGuessed))
            if guessingResult == "right":
                print("Hooray")
                print ("It took me %s guesses" % str(counter))
                break
            elif guessingResult == "low":
                del possibilities[0:middle]
            elif guessingResult == "high":
                del possibilities[middle:]
